...
Tip: These are rigid bodies. You may need to place the tool on top of the ball to use gravity to push the ball to its destination.
...
- Coordinate system: (0,0) is at BOTTOM-LEFT corner, (600,600) is at TOP-RIGHT corner
- This means: higher Y values = higher up in the scene
- Cannot overlap with black table or other objects
